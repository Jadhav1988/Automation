...
public class DataConfig {
	...
	public static void openExcelFile(String FileName, String SheetName) throws Exception {

		try {

			// Open the Excel file

			FileInputStream ExcelFile = new FileInputStream((System.getProperty("user.dir") + "\\inputs\\" + FileName +".xlsx"));
	...
	public static String getnumCellData(int RowNum, int ColNum) throws Exception{
	...
	public static void setCellData(String Result,  int RowNum, int ColNum) throws Exception	{
		...
		try{
			...
			FileOutputStream fileOut = new FileOutputStream("C:\\Users\\Mohan.jadhav\\Desktop\\output" + "Sheet1.xlsx");
